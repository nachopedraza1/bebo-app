        ...
        <TransitionPage>
            ...
            <Grid container direction="column" mt={2} gap={2}>
                ...
                <ul>
                    ...
                    <li> access, tamper with or use any non-public area of the Service or bebodesign.com's computer systems. </li>
                    ...
                    <li>use the Service in an abusive way contrary to its intended use, to bebodesign.com policies and instructions and to any applicable law.</li>
                    ...
                    <li>make use of, promote, link to or provide access to materials deemed by bebodesign.com at its sole discretion to be offensive or cause harm to bebodesign.com reputation, including, but not limited to, illegal content and pornographic content and content deemed offensive or injurious to bebodesign.com and/or the Service (such as Warez sites, IRC bots and bittorent sites)</li>
                </ul>
                ...
                <Typography> For customer service inquiries or disputes, you may contact us by email at support@bebodesign. Whenever possible, we will work with you and/or any user selling on our website to resolve any disputes arising from your purchase.</Typography>

                <Typography fontSize={17} fontWeight={600}>Return Policy</Typography>

                <Typography> Our bebodesign.com store does not provide a refund on digital products after they are purchased and shipped to your email address. Refund is only possible in case of delivery of damaged or garbled files and this is due to our fault.</Typography>
